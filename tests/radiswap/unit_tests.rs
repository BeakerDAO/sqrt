...
mod radiswap_test {
    ...
    fn test_add_liquidity() {
        ...
        test_env.call_method(RadiSwapMethods::AddLiquidity("usd".to_string(), dec!(1000), "btc".to_string(), dec!(100)));
    ...
    fn test_remove_liquidity() {
        ...
        test_env.call_method(RadiSwapMethods::RemoveLiquidity("usd-btc lp".to_string(), dec!(1)));
    ...
    fn test_swap() {
        ...
        test_env.call_method(RadiSwapMethods::Swap("usd".to_string(), dec!(1000)));
